...
var (
	requiredHeaders  = []string{"operation", "version"}
	validOperations  = []string{OperationTypeReportResource, OperationTypeDeleteResource, OperationTypeMigration}
	validApiVersions = []string{"v1beta2"}
